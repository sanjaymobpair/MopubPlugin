...
/**
 * this Class have All Setting Of MoPub Ads Integration
 */
public class MoPubPlugin extends GenericAdPlugin {
    private static final String LOGTAG = "MoPub";

    // TODO: 2019-05-09 Below is All Test Unit IDs for Banner or Intertial Ads
    ...
    // TODO: 2019-05-09 Default screenDensity
    ...
    protected void pluginInitialize() {
        ...
        // TODO: 2019-05-09 init DisplayMetrics
        DisplayMetrics metrics = new DisplayMetrics();
        cordova.getActivity().getWindowManager().getDefaultDisplay().getMetrics(metrics);

        // TODO: 2019-05-09 metrics density will screenDensity
        screenDensity = metrics.density;
        JSONObject json = new JSONObject();
        try {
//            json.put("isTesting", true);
            // TODO: 2019-05-09 set overlap true
            json.put("overlap", true);
    ...
    protected View __createAdView(String adId) {
        ...
        // TODO: 2019-05-09 init MoPubView to set AdUnitId
    ...
    protected void __pauseAdView(View view) {
        if (view instanceof MoPubView) {
            MoPubView ad = (MoPubView) view;
            // TODO: 2019-05-09 when pause method called setAutorefreshEnabled false, it will disable banner Ads View
    ...
    protected void __resumeAdView(View view) {
        if (view instanceof MoPubView) {
            MoPubView ad = (MoPubView) view;
            // TODO: 2019-05-09 when resume method called setAutorefreshEnabled true, it will refresh banner Ads View
    ...
    protected void __destroyAdView(View view) {
        if (view instanceof MoPubView) {
            // TODO: 2019-05-09 destroy AdView When __ondstroy called
            MoPubView ad = (MoPubView) view;
            ad.destroy();
        }
    }
